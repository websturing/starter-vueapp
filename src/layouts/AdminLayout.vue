    ...
    <div>
        ...
        <aside
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a :class="['nav-link', routeModules?.module == 'Dashboard' ? 'active' : '']"
                    ...
                    <li class="nav-item mt-3">
                        <h6 class="ps-4 ms-2 text-sm opacity-6">Applications Settings
                        </h6>
                    </li>
                    <li class="nav-item">
                        <a :class="['nav-link', routeModules?.module == 'Permissions' ? 'active' : '']"
                            :href="$router.resolve({ name: 'permissions' }).href"
                            @click.prevent="$router.push({ name: 'permissions' })">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="icon icon-blockchain-3 text-dark text-sm opacity-10"></i>
                            </div>
                            <span class="nav-link-text ms-1">Permission</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a :class="['nav-link', routeModules?.module == 'Users' ? 'active' : '']"
                            :href="$router.resolve({ name: 'users' }).href"
