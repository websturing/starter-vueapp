...
import { useShiftTable } from '@/modules/shift/composables/useShiftTable'
...
const columns = [
    ...
    { field: 'toleranceBreakdown.label', header: 'Tolerance' },
...
<template>
    <div class="space-y-4">
        <DataTableAction v-model:search="search" :onRefresh="refresh" :onPageChange="onPageChange"
            :onCreate="() => emit('edit', null)" :showCreate="true" labelCreate="Create Shift">
